...
namespace Victorine
{
    public partial class Button_Round : Button
    {
        private Color _borderColor = Color.FromArgb(238, 203, 171);
        private Color _onHoverBorderColor = Color.SeaGreen;
        private Color _buttonColor = Color.FromArgb(224, 133, 70);
        private Color _onHoverButtonColor = Color.SeaGreen;
